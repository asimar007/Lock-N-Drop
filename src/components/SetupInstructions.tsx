        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-base text-blue-800 mb-4">
              This app uses a simple database-based approach for secure file
              transfers. No WebRTC complexity!
            </p>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  Click "Connect to Supabase" in the top right to set up your
                  database
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  The required tables will be created automatically when you
                  connect
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  Files are encrypted, chunked, and transferred through the
                  database
                </p>
              </div>
            </div>
          ...
          <div className="bg-blue-100 rounded-lg p-4 mt-4">
            <h5 className="font-medium text-blue-900 mb-2 text-base">
              How it works:
            </h5>
          ...
          <div className="bg-amber-100 rounded-lg p-3 mt-4">
            <p className="text-xs text-amber-800">
              <strong>Demo Mode:</strong> Without Supabase, the app simulates
              transfers for testing the UI.
            </p>
          </div>
        </div>
      </div>
